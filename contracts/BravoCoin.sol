...
/**
 * @title The BravoCoin contract
 * @dev The Bravo Coin contract
 * @dev inherite from StandardToken and Ownable by Zeppelin
 * @author Koder.com
 */
contract BravoCoin is StandardToken, Ownable {
    string  public  constant name = 'Bravo Coin';
    string  public  constant symbol = 'BVO';
